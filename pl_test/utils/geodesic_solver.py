...
class GeodesicSolver(object):
    def __init__(self, config, alpha=1.6, beta=2.3, atomic_radius=ATOMIC_RADII_LIST, svd_tol=1e-3,):
    ...
    def geodesic_ode_solve(self, x, q_dot, edge_index, atom_type, q_type="morse",
        ...
        return x.reshape(-1, 3), x_dot.reshape(-1, 3), iter, total_dq, q_dot.norm()
