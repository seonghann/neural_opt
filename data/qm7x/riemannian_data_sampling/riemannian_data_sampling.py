...
def _remap_to_atomic_symbols(atomic_numbers: torch.Tensor) -> List[str]:
    """Convert atomic numbers to atomic symbols."""
    return [_index_to_atomic[num.item()] for num in atomic_numbers]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="save analysis results as a csv file",
    )
    parser.add_argument(
