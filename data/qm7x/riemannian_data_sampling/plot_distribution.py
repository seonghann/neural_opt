...
plot_hist_with_gaussian(df["__rmsd"], "Non-equilibrium", "green", (0, range_max), bins)
...
plot_hist_with_gaussian(df["__dmae"], "Non-equilibrium", "green", (0, range_max), bins)
...
plot_hist_with_gaussian(df["__q_norm"], "Non-equilibrium", "green", (0, range_max), bins)
